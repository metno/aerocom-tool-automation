...
if __name__ == '__main__':
	...
	parser.add_argument("-p","--print", help="switch on file name printing; external programs.",action='store_true')
	...
	parser.add_argument("--script", help="script to start; defaults to <tooldir>/StartBatchParam_MT_log.sh")
	parser.add_argument("--debug", help="switch on debug mode: Do NOT start idl, just print what would be done",action='store_true')
	parser.add_argument("--numcpu", help="Number of Processes to start. Default is half of what is available.",type=int)
